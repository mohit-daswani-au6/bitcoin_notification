...
def main(interval, upperlimit):
    ...
    while True:
        ...
        if price < upperlimit:
            post_ifttt_webhook('bitcoin_emergency_notifications', price)

        # Send a Telegram notification
        # Once we have 5 items in our price_list send an update

        if len(price_list) == 5:
            post_ifttt_webhook('Bitcoin_notifications',
...
temp1 = "nvrxGS4tsogIJpHpSgKHdLWjKsSzSPicmjox4C59paQ"
ifttt_webhook_url = \
    "https://maker.ifttt.com/trigger/{}/with/key/"+temp1
